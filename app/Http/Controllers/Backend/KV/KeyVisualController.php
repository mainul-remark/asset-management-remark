...
class KeyVisualController extends Controller
{
    public function index()
    {
        return view('backend.kv.kv-theme', [
            ...
            'permissions'    => [
                'canCreate'         => allowed('key-visuals.store'),
                'canView'           => allowed('key-visuals.show'),
                'canEdit'           => allowed('key-visuals.edit'),
                'canDelete'         => allowed('key-visuals.destroy'),
                'canCreateBrand'    => allowed('brands.store'),
                'canEditBrand'      => allowed('brands.edit'),
                'canDeleteBrand'    => allowed('brands.destroy'),
                'canCreateCategory' => allowed('categories.store'),
                'canEditCategory'   => allowed('categories.edit'),
                'canDeleteCategory' => allowed('categories.destroy'),
            ],
        ]);
    }
    public function old()
