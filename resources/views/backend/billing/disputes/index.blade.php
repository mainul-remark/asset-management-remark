...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4 mt-3">
        <div>
            <h4 class="fw-semibold mb-1">Bill Disputes
                @if($pendingCount > 0)
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="fw-semibold small">{{ $dispute->storeBrandBill?->store?->title }}</div>
                            </td>
                            <td>
                                <div class="fw-semibold small">{{ $dispute->storeBrandBill?->brand?->name }}</div>
                            </td>
